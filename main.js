...
//         eyeIcon.src = "https://cdn-icons-png.flaticon.com/512/159/159605.png"; // Открытый глаз
//     } else {
//         passwordInput.type = "password";
//         eyeIcon.src = "https://cdn-icons-png.flaticon.com/512/159/159604.png"; // Закрытый глаз
//     }
// }
...
function togglePassword(inputId, iconId) {
  ...
  if (passwordInput.type === "password") {
      ...
      passwordInput.type = "password";
      eyeIcon.src = "https://cdn-icons-png.flaticon.com/512/159/159604.png"; // Закрытый
  }
}
...
// document.addEventListener("DOMContentLoaded", function () {
//     var profileIcon = document.getElementById("profile-icon");
//     var mobileMenu = document.getElementById("profile-menu-mobile");
...
//     function closeMobileMenuOutsideClick(event) {
...
//     if (profileIcon) {
//         profileIcon.addEventListener("click", toggleMobileMenu);
//     }
...
document.addEventListener("DOMContentLoaded", function () {
  var profileIcon = document.getElementById("profile-icon");
  var desktopMenu = document.getElementById("profile-menu");
  var mobileMenu = document.getElementById("profile-menu-mobile");
  ...
  function toggleMenu(event) {
      ...
      if (window.innerWidth <= 500) { 
          // Мобильное меню
          mobileMenu.style.display = mobileMenu.style.display === "block" ? "none" : "block";
          desktopMenu.style.display = "none"; // Закрываем десктопное меню
      } else {
          // Десктопное меню
          desktopMenu.style.display = desktopMenu.style.display === "block" ? "none" : "block";
          mobileMenu.style.display = "none"; // Закрываем мобильное меню
      }
  }
